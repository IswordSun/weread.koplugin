...
function Sync:run()
    ...
    for index, chapter in ipairs(self.chapters) do
        ...
        -- Thoughts have already been committed in bounded transactions. The
        -- final write contains only source/projection metadata plus thought
        -- rows that disappeared in a completed refresh.
        local changes = {
